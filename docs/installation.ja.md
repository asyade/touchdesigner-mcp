...
マルチターゲット（asyade フォーク）のエージェント契約は英語の **[AGENT_MCP.md](AGENT_MCP.md)** を参照してください（Cursor 向け Method 2b は英語の [installation.md](installation.md#method-2b-cursor-local-fork--submodule-build)）。
